...
class Installer {
	 ...
	 */
	public function run(){
		echo "[*] LunCore Установщик языков\n";
		echo "[*] Выберите пожалуйста язык:\n";
...
Лучший выбор для любого сервера MCPE.
Автор ядра VK: vk.com/KlainYT Group: vk.com/luncore
Любая перепродажа может караться законом!
