...
class Installer {
	const DEFAULT_NAME = "LunCore: PE Server";
  ...
  Эта программа является платным программным обеспечением: ее запрещено распространять или модифицировать
  на условиях LunCore общественной лицензии ограниченного применения GNU, опубликованной
